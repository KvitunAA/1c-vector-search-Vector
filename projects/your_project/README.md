...
3. Отредактируйте `.env` — укажите `CONFIG_PATH` (путь к выгрузке 1С) и параметры эмбеддингов. При Qwen3 (LM Studio/GGUF): раскомментируйте `EMBEDDING_ADD_EOS_MANUAL=true`.
